...
def add_student():
    ...
    tk.Label(add_std_win, text="Student Name:", font=("Segoe UI", 10)).grid(row=1, column=0, padx=10, pady=5, sticky="e")
    name_entry = tk.Entry(add_std_win, width=25)
    name_entry.grid(row=1, column=1, padx=10, pady=5)

    tk.Label(add_std_win, text="Email:", font=("Segoe UI", 10)).grid(row=2, column=0, padx=10, pady=5, sticky="e")
    email_entry = tk.Entry(add_std_win, width=25)
    email_entry.grid(row=2, column=1, padx=10, pady=5)

    tk.Label(add_std_win, text="Address:", font=("Segoe UI", 10)).grid(row=3, column=0, padx=10, pady=5, sticky="e")
    ...
    tk.Radiobutton(add_std_win, text="Male", variable=gender_var, value="Male", bg="white").grid(row=4, column=1, sticky="w")
    tk.Radiobutton(add_std_win, text="Female", variable=gender_var, value="Female", bg="white").grid(row=4, column=1, padx=80, sticky="w")
    tk.Radiobutton(add_std_win, text="Other", variable=gender_var, value="Other", bg="white").grid(row=4, column=1, padx=160, sticky="w")

    tk.Label(add_std_win, text="Date of Birth (YYYY-MM-DD):", font=("Segoe UI", 10)).grid(row=5, column=0, padx=10, pady=5, sticky="e")
    ...
    tk.Radiobutton(add_std_win, text="1st Year", variable=year_var, value=1, bg="white").grid(row=6, column=1, sticky="w")
    tk.Radiobutton(add_std_win, text="2nd Year", variable=year_var, value=2, bg="white").grid(row=6, column=1, padx=80, sticky="w")
    tk.Radiobutton(add_std_win, text="3rd Year", variable=year_var, value=3, bg="white").grid(row=6, column=1, padx=160, sticky="w")
...
tk.Label(top_frame, text="1St Year Student", font=("Segoe UI", 16, "bold"), bg="white").pack(side="left", padx=(0, 10))

add_student_btn = tk.Button(top_frame, text="+Add Student",  command=add_student ,font=("Segoe UI", 10, "bold"), bg="#4FC3F7", fg="black", padx=10, pady=5, bd=0, activebackground="#0288d1", activeforeground="white")
add_student_btn.pack(side="right", padx=10)

main_frame = tk.Frame(_1stYearStudent, bg="white")
main_frame.pack(fill="both", expand=True, padx=10, pady=5)

student_table_1 = ttk.Treeview(main_frame, columns=("student ID", "Name", "Contact", "Address", "See More"), show="headings", height=10)
...
tk.Label(top_frame, text="2nd Year Student", font=("Segoe UI", 16, "bold"), bg="white").pack(side="left", padx=(0, 10))
...
student_table_2 = ttk.Treeview(main_frame, columns=("student ID", "Name", "Contact", "Address", "See More"), show="headings", height=10)
for col in ("student ID", "Name", "Contact", "Address", "See More"):
...
tk.Label(top_frame, text="3rd Year Student", font=("Segoe UI", 16, "bold"), bg="white").pack(side="left", padx=(0, 10))

student_table_3 = ttk.Treeview(main_frame, columns=("student ID", "Name", "Contact", "Address", "See More"), show="headings", height=10)
for col in ("student ID", "Name", "Contact", "Address", "See More"):
